    ...
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-[700px] h-[500px]">
      ...
      <Card className="absolute right-[20px] top-[-30px] w-80 flex flex-col justify-center items-center drop-shadow-xl shadow-black/10 dark:shadow-white/10">
        ...
        <CardFooter>
          <div>
            <Link
              href="https://my.server123.ir/index.php/store/server123/ansible"
              target="_blank"
            ...
            <Link
              href="https://my.server123.ir/index.php/store/server123/gitlab-ee"
              target="_blank"
              className={buttonVariants({
                variant: "ghost",
                size: "sm",
            ...
            <Link
              href="https://my.server123.ir/index.php/store/server123/wordpress"
              target="_blank"
              className={buttonVariants({
                variant: "ghost",
                size: "sm",
            ...
            >
              <span className="sr-only">WordPress icon</span>
